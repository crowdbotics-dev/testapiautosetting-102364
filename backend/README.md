...
## Project Structure
    ...
    ├── testapiautosetting_102364  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_102364`
...
2. Clone this repo and `cd testapiautosetting_102364`
